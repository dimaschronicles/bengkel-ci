...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form action="<?= base_url('montir/edit/' . $montir['id']); ?>" method="post">
                <div class="form-group row">
                    <label for="nama_montir" class="col-sm-2 col-form-label">Nama Lengkap</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama_montir" name="nama_montir" value="<?= $montir['nama_montir']; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="no_hp_montir" name="no_hp_montir" value="<?= $montir['no_hp_montir']; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" id="alamat_montir" name="alamat_montir" rows="3"><?= $montir['alamat_montir']; ?></textarea>
